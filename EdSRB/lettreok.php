...
echo 'var PasswordTooShort="Le mot de passe est incorrect car il contient moins de cinquente-quatre caractères. Ressaisissez-le tel qu'il apparaît dans le jeu puis réessayez."';
echo 'var NoPassword="Aucun mot de passe n'a été entré."';
echo 'var InvalidPasswordLong="Le mot de passe est incorrect. Ressaisissez-le puis réessayez."';
echo 'var NotSOSMail="Le mot de passe saisi n'est pas celui d'une Lettre S.O.S."';
echo 'var NotAOKMail="Le mot de passe saisi n'est pas celui d'une Lettre O.K."';
echo 'var SOSMailEnteredInAOK="Le mot de passe saisi semble être celui d'une Lettre S.O.S. et non d'une Lettre O.K.  Voulez-vous générer une Lettre O.K. à partir de ce mot de passe ? Si oui, sélectionnez OK."';
echo 'var AOKMailEnteredInSOS="Le mot de passe saisi semble être celui d'une Lettre O.K. et non d'une Lettre S.O.S.  Voulez-vous générer une Lettre Remeciement à partir de ce mot de passe ? Si oui, sélectionnez OK."';
...
echo '//]]>';
echo '</script>';
echo '<p>Vous pouvez vous secourir vous-même à l'aide de cet outil. Vous pouvez générer un mot de passe de Lettre O.K. et de Lettre Remerciement';
echo 'à partir d'un mot de passe de Lettre S.O.S ou d'une autre Lettre O.K. ou Remerciement.</p>';
echo '<ul>';
