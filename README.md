...
* Les sites et auteurs respectifs de ces outils :
    ...
    * Le site *PokéBip* ([www.pokebip.com](https://www.pokebip.com)) pour son vérificateur de Q.I. pour *PDM2* ;
    ...
    * Le site *Mangario* ([www.mangario.fr](https://web.archive.org/web/20210308082718/https://www.mangario.fr/)) pour avoir traduit en premier le générateur de Lettres Miracle de *PDM2TO* en français ;
...
* The respective sites and authors of these tools:
    ...
    * The *PokéBip* site ([www.pokebip.com](https://www.pokebip.com)) for its IQ checker for *PDM2*;
    * The *Mangario* site ([www.mangario.fr](https://web.archive.org/web/20210308082718/https://www.mangario.fr/)) for being the first to translate the *PMD2TD* Wonder Mail Generator into French;
